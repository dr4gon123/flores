...
| `authserver` | Remote Authentication server | `string` | 64 | user<br>wireless | 43011_-_LOG_ID_EVENT_AUTH_TIME_OUT, 43039_-_LOG_ID_EVENT_AUTH_LOGON, 43040_-_LOG_ID_EVENT_AUTH_LOGOUT<br>43524_-_LOG_ID_EVENT_WIRELESS_STA, 43572_-_LOG_ID_EVENT_WIRELESS_STA_ASSO, 43573_-_LOG_ID_EVENT_WIRELESS_STA_AUTH *(+63 more)* |
...
| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `ip` | *(empty)* | `ip` | 39 | fortiextender<br>ha<br>system<br>webproxy<br>wireless | 46401_-_LOG_ID_EVENT_EXT_LOCAL, 46402_-_LOG_ID_EVENT_EXT_LOCAL_ERROR, 46403_-_LOG_ID_EVENT_EXT_REMOTE_EMERG *(+7 more)*<br>37911_-_MESGID_HA_ACTIVITY_INFO<br>20150_-_LOG_ID_DEV_VUNL_FTGD_LOOKUP, 22035_-_LOG_ID_CSF_UPSTREAM_SN_CHANGED, 22036_-_LOG_ID_CSF_FGT_CONNECTED *(+10 more)*<br>40960_-_LOGID_EVENT_WEBPROXY_FWD_SRV_ERROR<br>43522_-_LOG_ID_EVENT_WIRELESS_WTP, 43526_-_LOG_ID_EVENT_WIRELESS_WTPR, 43528_-_LOG_ID_EVENT_WIRELESS_WTPR_ERROR *(+39 more)* |
...
| `mode` | Mode | `string` | 12 | sdwan<br>system | 22938_-_LOG_ID_EVENT_VWL_WAN_SPEEDTEST_RESULT<br>22800_-_LOG_ID_SCAN_SERV_FAIL |
...
| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `name` | *(empty)* | `string` | 128 | switch-controller | 22852_-_LOG_ID_USER_QUARANTINE_MAC_BOUNCE_PORT_HIT, 22853_-_LOG_ID_USER_QUARANTINE_MAC_BOUNCE_PORT_MISS, 22861_-_LOG_ID_FLPOLD_NAC_ADD *(+44 more)* |
| `name` | Display Name of the Connection | `string` | 128 | system<br>vpn | 22009_-_LOG_ID_FAIL_FIND_AV_PROFILE, 22203_-_LOG_ID_AUTO_GEN_CERT_FAIL, 22204_-_LOG_ID_AUTO_GEN_CERT_PENDING *(+12 more)*<br>41984_-_LOG_ID_EVENT_VPN_CERT_LOAD, 41985_-_LOG_ID_EVENT_VPN_CERT_REMOVAL, 41986_-_LOG_ID_EVENT_VPN_CERT_REGEN *(+5 more)* |
...
| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `sn` | *(empty)* | `string` | 64 | switch-controller | 22852_-_LOG_ID_USER_QUARANTINE_MAC_BOUNCE_PORT_HIT, 22853_-_LOG_ID_USER_QUARANTINE_MAC_BOUNCE_PORT_MISS, 22861_-_LOG_ID_FLPOLD_NAC_ADD *(+46 more)* |
...
| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `ui` | *(empty)* | `string` | 64 | switch-controller | 22850_-_LOG_ID_USER_QUARANTINE_MAC_ADD, 22851_-_LOG_ID_USER_QUARANTINE_MAC_DELETE, 22852_-_LOG_ID_USER_QUARANTINE_MAC_BOUNCE_PORT_HIT *(+53 more)* |
...
|----------------|-------------|-----------|--------|------|--------|
| `action` | *(empty)* | `string` | 11 | Webfilter<br>casb | 13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW *(+11 more)*<br>10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR |
...
| `action` | Security action performed by WF:<br> blocked - url is blocked by webfilter<br> passthrough - url is allowed by webfilter | `string` | 11 | Webfilter | 12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+43 more)* |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `devid` | *(empty)* | `string` | 16 | EmailFilter<br>FILE-FILTER<br>FORTI-SWITCH<br>ICAP<br>SSL<br>Virus<br>Webfilter<br>casb<br>virtual-patch | 20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF *(+2 more)*<br>64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>56001_-_LOG_ID_FSW_FLOW<br>60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_CONN_ERROR<br>62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY *(+18 more)*<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+68 more)*<br>13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW *(+11 more)*<br>10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR<br>64600_-_LOG_ID_OT_VPATCH_BLOCK, 64601_-_LOG_ID_OT_VPATCH_LOG, 64610_-_LOG_ID_LOCALIN_VPATCH_BLOCK *(+1 more)* |
...
| `devid` | Device ID | `string` | 16 | DLP<br>DNS<br>GTP<br>SSH<br>WAF<br>Webfilter | 24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF, 24578_-_LOG_ID_DLP_DOC_SOURCE *(+1 more)*<br>54000_-_LOG_ID_DNS_QUERY, 54200_-_LOG_ID_DNS_RESOLV_ERROR, 54400_-_LOG_ID_DNS_URL_FILTER_BLOCK *(+9 more)*<br>41216_-_LOGID_GTP_FORWARD, 41217_-_LOGID_GTP_DENY, 41218_-_LOGID_GTP_RATE_LIMIT *(+15 more)*<br>61000_-_LOG_ID_SSH_COMMAND_BLOCK, 61001_-_LOG_ID_SSH_COMMAND_BLOCK_ALERT, 61002_-_LOG_ID_SSH_COMMAND_PASS *(+5 more)*<br>30248_-_LOGID_WAF_SIGNATURE_BLOCK, 30249_-_LOGID_WAF_SIGNATURE_PASS, 30250_-_LOGID_WAF_SIGNATURE_ERASE *(+9 more)*<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+47 more)* |
...
| `dstip` | Destination IP Address | `ip` | 39 | Virus<br>WAF | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+52 more)*<br>30248_-_LOGID_WAF_SIGNATURE_BLOCK, 30249_-_LOGID_WAF_SIGNATURE_PASS, 30250_-_LOGID_WAF_SIGNATURE_ERASE *(+9 more)* |
...
| `eventtime` | Time when detection occured | `uint64` | 20 | Anomaly<br>IPS<br>Virus | 18432_-_LOGID_ATTCK_ANOMALY_TCP_UDP, 18433_-_LOGID_ATTCK_ANOMALY_ICMP, 18434_-_LOGID_ATTCK_ANOMALY_OTHERS<br>16384_-_LOGID_ATTCK_SIGNATURE_TCP_UDP, 16385_-_LOGID_ATTCK_SIGNATURE_ICMP, 16386_-_LOGID_ATTCK_SIGNATURE_OTHERS *(+3 more)*<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+52 more)* |
...
| `eventtype` | Event type of AV | `string` | 32 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+52 more)* |
...
| `group` | Group name (authentication) | `string` | 512 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+51 more)* |
...
| `msg` | Log message | `string` | 4096 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+51 more)* |
...
| `profile` | The name of the profile that was used to detect and take action | `string` | 64 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+51 more)* |
...
| `service` | Proxy service which scanned this traffic | `string` | 5 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+52 more)* |
...
| `srcip` | Source IP | `ip` | 39 | APP-CTRL<br>Anomaly<br>DLP<br>DNS<br>IPS<br>SSH<br>Webfilter | 28672_-_LOGID_APP_CTRL_IM_BASIC, 28673_-_LOGID_APP_CTRL_IM_BASIC_WITH_STATUS, 28674_-_LOGID_APP_CTRL_IM_BASIC_WITH_COUNT *(+11 more)*<br>18432_-_LOGID_ATTCK_ANOMALY_TCP_UDP, 18433_-_LOGID_ATTCK_ANOMALY_ICMP, 18434_-_LOGID_ATTCK_ANOMALY_OTHERS<br>24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF<br>54000_-_LOG_ID_DNS_QUERY, 54200_-_LOG_ID_DNS_RESOLV_ERROR, 54400_-_LOG_ID_DNS_URL_FILTER_BLOCK *(+9 more)*<br>16384_-_LOGID_ATTCK_SIGNATURE_TCP_UDP, 16385_-_LOGID_ATTCK_SIGNATURE_ICMP, 16386_-_LOGID_ATTCK_SIGNATURE_OTHERS *(+3 more)*<br>61000_-_LOG_ID_SSH_COMMAND_BLOCK, 61001_-_LOG_ID_SSH_COMMAND_BLOCK_ALERT, 61002_-_LOG_ID_SSH_COMMAND_PASS *(+5 more)*<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+45 more)* |
| `srcip` | Source IP Address | `ip` | 39 | Virus<br>WAF | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+52 more)*<br>30248_-_LOGID_WAF_SIGNATURE_BLOCK, 30249_-_LOGID_WAF_SIGNATURE_PASS, 30250_-_LOGID_WAF_SIGNATURE_ERASE *(+9 more)* |
...
| `subtype` | Subtype of the virus log | `string` | 20 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+52 more)* |
...
| `tz` | Time Zone | `string` | 5 | Virus<br>Webfilter | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+52 more)*<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+47 more)* |
...
| `url` | The URL address | `string` | 512 | APP-CTRL<br>DLP<br>IPS<br>Virus<br>Webfilter | 28704_-_LOGID_APP_CTRL_IPS_PASS, 28705_-_LOGID_APP_CTRL_IPS_BLOCK, 28706_-_LOGID_APP_CTRL_IPS_RESET *(+2 more)*<br>24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF<br>16384_-_LOGID_ATTCK_SIGNATURE_TCP_UDP, 16399_-_LOGID_ATTACK_MALICIOUS_URL<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+49 more)*<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+45 more)* |
...
| `user` | Username (authentication) | `string` | 256 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+51 more)* |
...
| `vd` | VDOM name | `string` | 32 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+52 more)* |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `vrf` | *(empty)* | `uint8` | 3 | EmailFilter<br>FILE-FILTER<br>ICAP<br>SSL<br>Virus<br>Webfilter<br>casb<br>virtual-patch | 20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF *(+2 more)*<br>64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_CONN_ERROR<br>62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY *(+18 more)*<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+67 more)*<br>13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW *(+11 more)*<br>10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR<br>64600_-_LOG_ID_OT_VPATCH_BLOCK, 64601_-_LOG_ID_OT_VPATCH_LOG, 64610_-_LOG_ID_LOCALIN_VPATCH_BLOCK *(+1 more)* |
...
### 7.4.1 → 7.4.2 — Inter-version Changes
...
|----------------|-------------|-----------|--------|--------|
| `clientcert` | *(empty)* | `string` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `clientdeviceems` | *(empty)* | `string` | 16 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `durationdelta` | *(empty)* | `uint32` | 20 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `rcvdpktdelta` | *(empty)* | `uint32` | 20 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `sentpktdelta` | *(empty)* | `uint32` | 20 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
...
| LOGID | Category |
|-------|----------|
| `20139_-_LOG_ID_FGCS_ACC_LIC_EXPIRE` | system |
| `20140_-_LOG_ID_FSPA_LIC_EXPIRE` | system |
| `20141_-_LOG_ID_FSFG_LIC_EXPIRE` | system |
| `22022_-_LOG_ID_ENTER_EXTREME_LOW_MEM_MODE` | system |
| `22023_-_LOG_ID_LEAVE_EXTREME_LOW_MEM_MODE` | system |
| `22817_-_LOG_ID_SCANUNIT_DLP_SIGNATURE_REMOVE` | system |
| `22874_-_LOG_ID_FLTUND_NEW_CONN` | switch-controller |
| `22875_-_LOG_ID_FLTUND_CONN_DOWN` | switch-controller |
| `22876_-_LOG_ID_FLTUND_RCV_BOOTSTRAP` | switch-controller |
| `22877_-_LOG_ID_FLTUND_CONN_ONLINE` | switch-controller |
| `22878_-_LOG_ID_FLTUND_CONN_OFFLINE` | switch-controller |
| `34420_-_LOG_ID_NP6XLITE_HPE_PACKET_DROP` | system |
| `34421_-_LOG_ID_NP6XLITE_HPE_PACKET_FLOOD` | system |
| `45101_-_LOG_ID_EC_REG_SUCCEED` | endpoint |
| `45132_-_LOG_ID_EC_EMS_UPGRADE_FAIL` | endpoint |
| `45133_-_LOG_ID_EC_SHM_MISSING_QUERY` | endpoint |

**LOGIDs removed**

| LOGID | Category |
|-------|----------|
| `22104_-_LOG_ID_POWER_RESTORE` | system |

**Fields added**

| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `action` | *(empty)* | `string` | 65 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `action` | Policy Action | `string` | 65 | system | 32099_-_LOG_ID_CHG_CONFIG_INFO |
| `cert` | Certificate | `string` | 36 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `desc` | Description | `string` | 128 | system | 32099_-_LOG_ID_CHG_CONFIG_INFO |
| `eventtype` | *(empty)* | `string` | 48 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `informationsource` | Information Source | `string` | 4096 | system | 32099_-_LOG_ID_CHG_CONFIG_INFO |
| `reason` | Reason | `string` | 256 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `signal` | The signal value of SSID or client | `int8` | 4 | wireless | 43629_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_AUTH_FAILURE, 43630_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_AUTH_SUCCESS, 43631_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_AUTH_NO_RESP, 43632_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_MAC_AUTH_FAILURE, 43633_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_MAC_AUTH_SUCCESS *(+37 more)* |
| `snr` | *(empty)* | `int8` | 4 | wireless | 43629_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_AUTH_FAILURE, 43630_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_AUTH_SUCCESS, 43631_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_AUTH_NO_RESP, 43632_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_MAC_AUTH_FAILURE, 43633_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_MAC_AUTH_SUCCESS *(+37 more)* |
| `srccountry` | *(empty)* | `string` | 64 | vpn | 39425_-_LOG_ID_EVENT_SSL_VPN_USER_TUNNEL_DOWN, 39936_-_LOG_ID_EVENT_SSL_VPN_SESSION_WEB_TUNNEL_STATS, 39937_-_LOG_ID_EVENT_SSL_VPN_SESSION_WEBAPP_DENY, 39938_-_LOG_ID_EVENT_SSL_VPN_SESSION_WEBAPP_PASS, 39939_-_LOG_ID_EVENT_SSL_VPN_SESSION_WEBAPP_TIMEOUT *(+4 more)* |
| `srcip` | *(empty)* | `ip` | 39 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `srcmac` | *(empty)* | `string` | 17 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `status` | Status | `string` | 23 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `status` | Status | `string` | 23 | system | 32099_-_LOG_ID_CHG_CONFIG_INFO |
| `switchaclid` | *(empty)* | `uint32` | 10 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `switchautoip` | *(empty)* | `ip` | 39 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `switchinterface` | *(empty)* | `string` | 16 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `switchl2capacity` | *(empty)* | `uint32` | 10 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `switchl2count` | *(empty)* | `uint32` | 10 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `switchmirrorsession` | *(empty)* | `string` | 16 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `switchphysicalport` | *(empty)* | `string` | 16 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `switchsysteminterface` | *(empty)* | `string` | 16 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `switchtrunk` | *(empty)* | `string` | 16 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `switchtrunkinterface` | *(empty)* | `string` | 16 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |
| `vlan` | *(empty)* | `uint32` | 10 | switch-controller | 32569_-_LOG_ID_FSW_SWITCH_LOG_EVENT |

**Fields removed**

| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `severity` | *(empty)* | `string` | 10 | system | 20232_-_LOG_ID_SYS_SECURITY_LOAD_MODULE_VIOLATION |
| `unit` | Unit | `uint32` | 10 | system | 22105_-_LOG_ID_POWER_FAILURE |

**Length changes**

| Log Field Name | Old Length | New Length | Category | LOGIDs |
|----------------|------------|------------|----------|--------|
| `eventtype` | 32 | 48 | sdwan | 22923_-_LOG_ID_EVENT_VWL_LQTY_STATUS, 22924_-_LOG_ID_EVENT_VWL_VOLUME_STATUS, 22925_-_LOG_ID_EVENT_VWL_SLA_INFO, 22926_-_LOG_ID_EVENT_VWL_NEIGHBOR_STATUS, 22927_-_LOG_ID_EVENT_VWL_NEIGHBOR_STANDALONE *(+11 more)* |
...
| LOGID | Type |
|-------|------|
| `13617_-_LOG_ID_CONTENT_TYPE_EXEMPT` | Webfilter |
| `13712_-_LOG_ID_VIDEOFILTER_TITLE_BLOCK` | Webfilter |
| `13713_-_LOG_ID_VIDEOFILTER_TITLE_MONITOR` | Webfilter |
| `13714_-_LOG_ID_VIDEOFILTER_TITLE_ALLOW` | Webfilter |
| `13728_-_LOG_ID_VIDEOFILTER_DESCRIPTION_BLOCK` | Webfilter |
| `13729_-_LOG_ID_VIDEOFILTER_DESCRIPTION_MONITOR` | Webfilter |
| `13730_-_LOG_ID_VIDEOFILTER_DESCRIPTION_ALLOW` | Webfilter |
| `60002_-_LOG_ID_ICAP_CONN_ERROR` | ICAP |
| `62309_-_LOG_ID_SSL_ANOMALY_CERT_INVALID` | SSL |
| `64600_-_LOG_ID_OT_VPATCH_BLOCK` | virtual-patch |
| `64601_-_LOG_ID_OT_VPATCH_LOG` | virtual-patch |
| `64610_-_LOG_ID_LOCALIN_VPATCH_BLOCK` | virtual-patch |
| `64611_-_LOG_ID_LOCALIN_VPATCH_LOG` | virtual-patch |
| `8982_-_MESGID_SCAN_AV_MAX_MEMORY_REACHED_ERROR` | Virus |

**LOGIDs removed**

| LOGID | Type |
|-------|------|
| `60002_-_LOG_ID_ICAP_SERVER_CLOSE_CONN` | ICAP |
| `64600_-_LOG_ID_VPATCH_BLOCK` | virtual-patch |
| `64601_-_LOG_ID_VPATCH_LOG` | virtual-patch |

**Fields added**

| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `dstuuid` | *(empty)* | `string` | 37 | casb | 10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR |
| `reason` | *(empty)* | `string` | 4096 | ICAP | 60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK |
| `ruleid` | *(empty)* | `uint32` | 10 | DLP | 24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF |
| `rulename` | *(empty)* | `string` | 128 | DLP | 24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF |
| `rulename` | *(empty)* | `string` | 36 | FILE-FILTER | 64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG |
| `srcuuid` | *(empty)* | `string` | 37 | casb | 10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR |
| `videodesc` | *(empty)* | `string` | 64 | Webfilter | 13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW, 13680_-_LOG_ID_VIDEOFILTER_CHANNEL_BLOCK, 13681_-_LOG_ID_VIDEOFILTER_CHANNEL_MONITOR *(+1 more)* |
| `videotitle` | *(empty)* | `string` | 512 | Webfilter | 13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW, 13680_-_LOG_ID_VIDEOFILTER_CHANNEL_BLOCK, 13681_-_LOG_ID_VIDEOFILTER_CHANNEL_MONITOR *(+1 more)* |

**Fields removed**

| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `filteridx` | DLP filter ID | `uint32` | 10 | DLP | 24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF |
