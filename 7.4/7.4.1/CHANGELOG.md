...
| SSL | 63 | 20 | 5 | ssl-anomaly, ssl-exempt, ssl-handshake, ssl-negotiation, ssl-server-cert-info |
| Virus | 93 | 70 | 15 | analytics, command-blocked, content-disarm, ems-threat-feed, exempt-hash, filename, filetype-executable, infected, inline-block, malware-list, mimefragmented, outbreak-prevention, oversize, scanerror, switchproto |
| VoIP | 45 | 7 | 1 | voip |
...
| casb | 33 | 3 | 1 | casb |
| virtual-patch | 57 | 2 | 1 | virtual-patch |
...
|----------------|-------------|-----------|--------|------|--------|
| `action` | *(empty)* | `string` | 11 | Webfilter<br>casb | 13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW *(+5 more)*<br>10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR |
| `action` | *(empty)* | `string` | 16 | virtual-patch | 64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| `action` | *(empty)* | `string` | 20 | FILE-FILTER<br>SSL | 64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY *(+17 more)* |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `attack` | *(empty)* | `string` | 256 | virtual-patch | 64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `attackcontext` | *(empty)* | `string` | 2048 | virtual-patch | 64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `attackcontextid` | *(empty)* | `string` | 10 | virtual-patch | 64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `attackid` | *(empty)* | `uint32` | 10 | virtual-patch | 64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| `cc` | *(empty)* | `string` | 512 | DLP<br>FILE-FILTER<br>Virus | 24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF<br>64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+59 more)* |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `devid` | *(empty)* | `string` | 16 | EmailFilter<br>FILE-FILTER<br>FORTI-SWITCH<br>ICAP<br>SSL<br>Virus<br>Webfilter<br>casb<br>virtual-patch | 20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF *(+2 more)*<br>64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>56001_-_LOG_ID_FSW_FLOW<br>60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_SERVER_CLOSE_CONN<br>62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY *(+17 more)*<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+67 more)*<br>13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW *(+5 more)*<br>10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR<br>64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `dstintf` | *(empty)* | `string` | 32 | FILE-FILTER<br>ICAP<br>SSL<br>Virus<br>Webfilter<br>casb | 64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_SERVER_CLOSE_CONN<br>62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY *(+17 more)*<br>8216_-_MESGID_FILE_HASH_EMS_WARNING, 8217_-_MESGID_FILE_HASH_EMS_NOTIF, 8218_-_MESGID_MIME_FILE_HASH_EMS_WARNING *(+13 more)*<br>13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW *(+5 more)*<br>10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR |
| `dstintf` | *(empty)* | `string` | 64 | EmailFilter<br>virtual-patch | 20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF *(+2 more)*<br>64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `forwardedfor` | *(empty)* | `string` | 128 | FILE-FILTER<br>Virus<br>virtual-patch | 64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+60 more)*<br>64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `msg` | *(empty)* | `string` | 4096 | ICAP<br>Virus | 60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_SERVER_CLOSE_CONN<br>8216_-_MESGID_FILE_HASH_EMS_WARNING, 8217_-_MESGID_FILE_HASH_EMS_NOTIF, 8218_-_MESGID_MIME_FILE_HASH_EMS_WARNING *(+13 more)* |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `rawdata` | *(empty)* | `string` | 20480 | FILE-FILTER<br>Virus<br>virtual-patch | 64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+54 more)*<br>64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| `service` | *(empty)* | `string` | 80 | virtual-patch | 64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `severity` | *(empty)* | `string` | 8 | virtual-patch | 64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `srcintf` | *(empty)* | `string` | 32 | FILE-FILTER<br>ICAP<br>SSL<br>Virus<br>Webfilter<br>casb | 64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_SERVER_CLOSE_CONN<br>62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY *(+17 more)*<br>8216_-_MESGID_FILE_HASH_EMS_WARNING, 8217_-_MESGID_FILE_HASH_EMS_NOTIF, 8218_-_MESGID_MIME_FILE_HASH_EMS_WARNING *(+13 more)*<br>13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW *(+5 more)*<br>10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR |
| `srcintf` | *(empty)* | `string` | 64 | EmailFilter<br>virtual-patch | 20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF *(+2 more)*<br>64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `subject` | *(empty)* | `string` | 256 | EmailFilter<br>FILE-FILTER<br>Virus | 20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF *(+2 more)*<br>64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+59 more)* |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `trueclntip` | *(empty)* | `ip` | 39 | FILE-FILTER<br>Virus<br>virtual-patch | 64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+60 more)*<br>64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `unauthuser` | *(empty)* | `string` | 66 | EmailFilter<br>FILE-FILTER<br>SSL<br>Virus<br>virtual-patch | 20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF *(+2 more)*<br>64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY *(+17 more)*<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+67 more)*<br>64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `url` | *(empty)* | `string` | 512 | FILE-FILTER<br>ICAP<br>Virus<br>Webfilter<br>casb<br>virtual-patch | 64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_SERVER_CLOSE_CONN<br>8216_-_MESGID_FILE_HASH_EMS_WARNING, 8217_-_MESGID_FILE_HASH_EMS_NOTIF, 8218_-_MESGID_MIME_FILE_HASH_EMS_WARNING *(+13 more)*<br>13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW *(+5 more)*<br>10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR<br>64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `vrf` | *(empty)* | `uint8` | 3 | EmailFilter<br>FILE-FILTER<br>ICAP<br>SSL<br>Virus<br>Webfilter<br>casb<br>virtual-patch | 20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF *(+2 more)*<br>64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_SERVER_CLOSE_CONN<br>62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY *(+17 more)*<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+66 more)*<br>13664_-_LOG_ID_VIDEOFILTER_CATEGORY_BLOCK, 13665_-_LOG_ID_VIDEOFILTER_CATEGORY_MONITOR, 13666_-_LOG_ID_VIDEOFILTER_CATEGORY_ALLOW *(+5 more)*<br>10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR<br>64600_-_LOG_ID_VPATCH_BLOCK, 64601_-_LOG_ID_VPATCH_LOG |
...
### 7.4.0 → 7.4.1 — Inter-version Changes
...
|----------------|-------------|-----------|--------|--------|
| `countcasb` | *(empty)* | `uint32` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 17_-_LOG_ID_TRAFFIC_SNIFFER, 22_-_LOG_ID_TRAFFIC_UTM_CORRELATION, 8_-_LOG_ID_TRAFFIC_WANOPT *(+1 more)* |
| `countvpatch` | *(empty)* | `uint32` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 17_-_LOG_ID_TRAFFIC_SNIFFER, 22_-_LOG_ID_TRAFFIC_UTM_CORRELATION, 8_-_LOG_ID_TRAFFIC_WANOPT *(+1 more)* |
| `replydstintf` | *(empty)* | `string` | 32 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `replysrcintf` | *(empty)* | `string` | 32 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
...
| LOGID | Category |
|-------|----------|
| `20137_-_LOG_ID_FGSA_LIC_EXPIRE` | system |
| `20138_-_LOG_ID_SWOS_LIC_EXPIRE` | system |
| `20235_-_LOG_ID_SYS_SECURITY_MOUNT_VIOLATION` | system |
| `22939_-_LOG_ID_EVENT_VWL_FAIL_DETECT` | sdwan |
| `22940_-_LOG_ID_EVENT_LINK_MONITOR_FAIL_DETECT` | system |
| `32055_-_LOG_ID_CC_KAT_SUCCESS` | system |
| `32264_-_LOG_ID_BLE_FIRMWARE_CHECK` | system |
| `32265_-_LOG_ID_BLE_FIRMWARE_UPDATE` | system |
| `46522_-_LOG_ID_INTERNAL_LTE_MODEM_BILLING_DATA_ALERT` | system |
| `46523_-_LOG_ID_INTERNAL_LTE_MODEM_BILLING_TIME_REFRESH` | system |
| `46524_-_LOG_ID_INTERNAL_LTE_MODEM_SIM_SWITCH_DATA_PLAN` | system |
| `46525_-_LOG_ID_INTERNAL_LTE_MODEM_BILLING_STOP_NETWORK` | system |
| `46526_-_LOG_ID_INTERNAL_LTE_MODEM_BILLING_DATA_PLAN_OVER` | system |
| `53406_-_LOG_ID_2GB_CSF_UPGRADE` | system |

**LOGIDs removed**

| LOGID | Category |
|-------|----------|
| `32019_-_LOG_ID_CC_ENTER_ERR_MOD` | system |
| `45057_-_LOG_ID_FCC_ADD` | endpoint |
| `45058_-_LOG_ID_FCC_CLOSE` | endpoint |
| `45061_-_LOG_ID_FCC_CLOSE_BY_TYPE` | endpoint |
| `46506_-_LOG_ID_INTERNAL_LTE_MODEM_BILLING_DAILY_LOG` | system |

**Fields added**

| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `devintfname` | HA device interface name | `string` | 32 | router | 51000_-_LOG_ID_NB_TBL_CHG |
| `latency` | *(empty)* | `string` | 24 | sdwan | 22938_-_LOG_ID_EVENT_VWL_WAN_SPEEDTEST_RESULT |
| `mode` | Mode | `string` | 12 | sdwan | 22938_-_LOG_ID_EVENT_VWL_WAN_SPEEDTEST_RESULT |
| `protocol` | *(empty)* | `string` | 128 | sdwan | 22938_-_LOG_ID_EVENT_VWL_WAN_SPEEDTEST_RESULT |
| `snprev` | *(empty)* | `string` | 36 | wireless | 43574_-_LOG_ID_EVENT_WIRELESS_STA_DASS, 43575_-_LOG_ID_EVENT_WIRELESS_STA_DAUT, 43577_-_LOG_ID_EVENT_WIRELESS_STA_DENY, 43629_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_AUTH_FAILURE, 43630_-_LOG_ID_EVENT_WIRELESS_STA_RADIUS_AUTH_SUCCESS *(+62 more)* |

**Fields removed**

| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `fctemssn` | *(empty)* | `string` | 16 | connector | 53202_-_LOG_ID_CONNECTOR_API_FAILED |

**Length changes**

| Log Field Name | Old Length | New Length | Category | LOGIDs |
|----------------|------------|------------|----------|--------|
| `vip` | 64 | 80 | system | 46000_-_LOG_ID_VIP_REAL_SVR_ENA, 46001_-_LOG_ID_VIP_REAL_SVR_DISA, 46002_-_LOG_ID_VIP_REAL_SVR_UP, 46003_-_LOG_ID_VIP_REAL_SVR_DOWN, 46004_-_LOG_ID_VIP_REAL_SVR_ENT_HOLDDOWN *(+2 more)* |
...
| LOGID | Type |
|-------|------|
| `10000_-_LOG_ID_CASB_ACCESS_BLOCKED` | casb |
| `10001_-_LOG_ID_CASB_ACCESS_BYPASS` | casb |
| `10002_-_LOG_ID_CASB_ACCESS_MONITOR` | casb |
| `62308_-_LOG_ID_SSL_ANOMALY_HANDSHAKE_FAILURE` | SSL |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `poluuid` | *(empty)* | `string` | 37 | SSH | 61000_-_LOG_ID_SSH_COMMAND_BLOCK, 61001_-_LOG_ID_SSH_COMMAND_BLOCK_ALERT, 61002_-_LOG_ID_SSH_COMMAND_PASS, 61003_-_LOG_ID_SSH_COMMAND_PASS_ALERT, 61010_-_LOG_ID_SSH_CHANNEL_BLOCK *(+3 more)* |
