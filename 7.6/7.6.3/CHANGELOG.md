...
|------|--------|--------|------------|---------------|
| APP-CTRL | 80 | 15 | 3 | port-violation, protocol-violation, signature |
| Anomaly | 46 | 3 | 1 | anomaly |
| DLP | 82 | 4 | 2 | dlp, dlp-docsource |
| DNS | 55 | 13 | 2 | dns-query, dns-response |
| Debug | 12 | 1 | 1 | debug |
| EmailFilter | 60 | 5 | 5 | bannedword, email, ftgd_err, spam, webmail |
| FILE-FILTER | 72 | 2 | 1 | file-filter |
| FORTI-SWITCH | 18 | 1 | 1 | fsw-flow |
| GTP | 86 | 18 | 2 | gtp-all, pfcp-all |
| ICAP | 41 | 3 | 1 | icap |
| IPS | 72 | 7 | 3 | botnet, malicious-url, signature |
| SSH | 43 | 10 | 4 | ssh-channel, ssh-command, ssh-hostkey, ssh-unsupport-proto |
| SSL | 66 | 21 | 5 | ssl-anomaly, ssl-exempt, ssl-handshake, ssl-negotiation, ssl-server-cert-info |
| Virus | 100 | 77 | 17 | 0-day-malware-stream, analytics, command-blocked, content-disarm, ems-threat-feed, exempt-hash, filename, filetype-executable, infected, inline-block, malware-list, mimefragmented, outbreak-prevention, oversize, scanerror, switchproto, unknown-ce |
| VoIP | 47 | 7 | 1 | voip |
| WAF | 53 | 12 | 6 | waf-address-list, waf-custom-signature, waf-http-constraint, waf-http-method, waf-signature, waf-url-access |
| Webfilter | 92 | 65 | 22 | activexfilter, antiphishing, appletfilter, content, cookiefilter, domain-fronting, ftgd_allow, ftgd_blk, ftgd_err, ftgd_quota, ftgd_quota_counting, ftgd_quota_expired, http_header_change, scriptfilter, ssl-exempt, urlfilter, urlmonitor, videofilter-category, videofilter-channel, videofilter-description, videofilter-title, webfilter_command_block |
| casb | 41 | 3 | 1 | casb |
| virtual-patch | 58 | 4 | 2 | localin-vpatch, ot-vpatch |

### 7.6.3 — Intra-version Inconsistencies
...
| `action` | Policy Action | `string` | 65 | connector<br>router<br>system<br>user<br>vpn<br>wireless | 53200_-_LOG_ID_CONNECTOR_OBJECT_ADD, 53201_-_LOG_ID_CONNECTOR_OBJECT_REMOVE<br>20401_-_LOG_ID_ROUTER_CLEAR, 51000_-_LOG_ID_NB_TBL_CHG<br>20002_-_LOG_ID_DOMAIN_UNRESOLVABLE, 20003_-_LOG_ID_MAIL_SENT_FAIL, 20021_-_LOG_ID_MAIL_RESENT *(+230 more)*<br>38010_-_LOG_ID_FIPS_ENCRY_FAIL, 38011_-_LOG_ID_FIPS_DECRY_FAIL, 38012_-_LOG_ID_ENTROPY_TOKEN *(+30 more)*<br>23101_-_LOG_ID_IPSEC_TUNNEL_UP, 23102_-_LOG_ID_IPSEC_TUNNEL_DOWN, 23103_-_LOG_ID_IPSEC_TUNNEL_STAT *(+75 more)*<br>43520_-_LOG_ID_EVENT_WIRELESS_SYS, 43521_-_LOG_ID_EVENT_WIRELESS_ROGUE, 43522_-_LOG_ID_EVENT_WIRELESS_WTP *(+190 more)* |
...
| `mode` | Mode | `string` | 12 | sdwan<br>system | 22938_-_LOG_ID_EVENT_VWL_WAN_SPEEDTEST_RESULT<br>22800_-_LOG_ID_SCAN_SERV_FAIL, 22907_-_LOG_ID_INPUT_DETECTION |
...
| `cc` | *(empty)* | `string` | 512 | DLP<br>FILE-FILTER<br>Virus | 24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF<br>64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+64 more)* |
...
| `forwardedfor` | Forwarded For | `string` | 128 | APP-CTRL<br>DLP | 28704_-_LOGID_APP_CTRL_IPS_PASS, 28705_-_LOGID_APP_CTRL_IPS_BLOCK, 28706_-_LOGID_APP_CTRL_IPS_RESET *(+3 more)*<br>24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF |
...
| `service` | Service name | `string` | 36 | DLP<br>Webfilter | 24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+47 more)* |
...
| `vrf` | Virtual Routing Forwarding | `uint16` | 3 | APP-CTRL<br>DLP | 28672_-_LOGID_APP_CTRL_IM_BASIC, 28673_-_LOGID_APP_CTRL_IM_BASIC_WITH_STATUS, 28674_-_LOGID_APP_CTRL_IM_BASIC_WITH_COUNT *(+12 more)*<br>24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF |
| `vrf` | Virtual router forwarding | `uint16` | 3 | Anomaly<br>IPS<br>Webfilter | 18432_-_LOGID_ATTCK_ANOMALY_TCP_UDP, 18433_-_LOGID_ATTCK_ANOMALY_ICMP, 18434_-_LOGID_ATTCK_ANOMALY_OTHERS<br>16384_-_LOGID_ATTCK_SIGNATURE_TCP_UDP, 16385_-_LOGID_ATTCK_SIGNATURE_ICMP, 16386_-_LOGID_ATTCK_SIGNATURE_OTHERS *(+4 more)*<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+45 more)* |

---

### 7.6.2 → 7.6.3 — Inter-version Changes
...
|----------------|-------------|-----------|--------|--------|
| `tunneldstip` | *(empty)* | `ip` | 39 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `tunnelproto` | *(empty)* | `string` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `tunnelsessionid` | *(empty)* | `uint32` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `tunnelsrcip` | *(empty)* | `ip` | 39 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `vipincomingip` | *(empty)* | `ip` | 39 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
...
| LOGID | Category |
|-------|----------|
| `22819_-_LOG_ID_SCANUNIT_DLP_BUILDER_PATTERN_SKIP` | system |
| `22941_-_LOG_ID_EVENT_VWL_PASS_APP_PERF` | sdwan |
| `22942_-_LOG_ID_EVENT_LINK_MONITOR_BUILD_ERR` | system |
| `37143_-_MESGID_PH1_PEER_PROPOSAL` | vpn |
| `37144_-_MESGID_PH2_PEER_PROPOSAL` | vpn |
| `38422_-_LOGID_EVENT_ICBD_UPDATE_SUCCESS` | system |
| `38423_-_LOGID_EVENT_ICBD_UPDATE_FAILURE` | system |
| `43056_-_LOG_ID_EVENT_AUTH_SERVER_REACHABILITY_UPDATE` | user |
| `44559_-_LOGID_EVENT_INSTALL_IPROPE` | system |
| `44560_-_LOGID_EVENT_CONFIG_ACCPROFILE_SUPER_ADMIN` | system |
| `44561_-_LOGID_EVENT_CONFIG_REQUEST_UNAUTH` | system |
| `47005_-_LOG_ID_MALWARE_STREAM_TRUNCATED_ENTER` | system |
| `47006_-_LOG_ID_MALWARE_STREAM_TRUNCATED_EXIT` | system |
| `52002_-_LOG_ID_EVENT_SECURITY_AUDIT_FABRIC_RESULT` | security-rating |
| `53326_-_LOG_ID_NPU_HEALTH_INFO` | system |
| `53327_-_LOG_ID_NPU_HEALTH_WARNING` | system |
| `53328_-_LOG_ID_NPU_HEALTH_ERROR` | system |

**Fields added**

| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `eapauthgroup` | *(empty)* | `string` | 128 | vpn | 37120_-_MESGID_NEG_GENERIC_P1_NOTIF, 37121_-_MESGID_NEG_GENERIC_P1_ERROR, 37122_-_MESGID_NEG_GENERIC_P2_NOTIF, 37123_-_MESGID_NEG_GENERIC_P2_ERROR, 37124_-_MESGID_NEG_I_P1_ERROR *(+17 more)* |
| `eapuser` | *(empty)* | `string` | 256 | vpn | 37120_-_MESGID_NEG_GENERIC_P1_NOTIF, 37121_-_MESGID_NEG_GENERIC_P1_ERROR, 37122_-_MESGID_NEG_GENERIC_P2_NOTIF, 37123_-_MESGID_NEG_GENERIC_P2_ERROR, 37124_-_MESGID_NEG_I_P1_ERROR *(+17 more)* |
| `method` | Method | `string` | 64 | user | 43025_-_LOG_ID_EVENT_AUTH_PROXY_SUCCESS, 43026_-_LOG_ID_EVENT_AUTH_PROXY_FAILED, 43028_-_LOG_ID_EVENT_AUTH_PROXY_GROUP_INFO_FAILED, 43032_-_LOG_ID_EVENT_AUTH_PROXY_USER_LIMIT_REACHED, 43033_-_LOG_ID_EVENT_AUTH_PROXY_MULTIPLE_LOGIN |
| `trafficmode` | *(empty)* | `string` | 8 | wireless | 43524_-_LOG_ID_EVENT_WIRELESS_STA, 43526_-_LOG_ID_EVENT_WIRELESS_WTPR, 43528_-_LOG_ID_EVENT_WIRELESS_WTPR_ERROR, 43572_-_LOG_ID_EVENT_WIRELESS_STA_ASSO, 43573_-_LOG_ID_EVENT_WIRELESS_STA_AUTH *(+115 more)* |

**Fields removed**

| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `xauthgroup` | IPsec VPN Xauth user group name | `string` | 128 | vpn | 37142_-_MESGID_TRANSPORT_SWITCH |
| `xauthuser` | IPsec VPN Xauth user name | `string` | 256 | vpn | 37142_-_MESGID_TRANSPORT_SWITCH |

**Length changes**

| Log Field Name | Old Length | New Length | Category | LOGIDs |
|----------------|------------|------------|----------|--------|
| `cert-type` | 6 | 9 | vpn | 41984_-_LOG_ID_EVENT_VPN_CERT_LOAD, 41985_-_LOG_ID_EVENT_VPN_CERT_REMOVAL, 41986_-_LOG_ID_EVENT_VPN_CERT_REGEN, 41987_-_LOG_ID_EVENT_VPN_CERT_UPDATE, 41989_-_LOG_ID_EVENT_VPN_CERT_ERR *(+3 more)* |
...
| LOGID | Type |
|-------|------|
| `16402_-_LOGID_ATTACK_SIGNATURE_L2` | IPS |
| `28738_-_LOGID_APP_CTRL_DETECT_L2` | APP-CTRL |
| `54806_-_LOG_ID_DNS_SVCPARAM_ECH` | DNS |
| `65290_-_LOG_ID_DEBUG_PRINT` | Debug |
| `8244_-_MESGID_MALWARE_STREAM_WARNING` | Virus |
| `8245_-_MESGID_MALWARE_STREAM_NOTIF` | Virus |
| `8246_-_MESGID_MIME_MALWARE_STREAM_WARNING` | Virus |
| `8247_-_MESGID_MIME_MALWARE_STREAM_NOTIF` | Virus |

**Fields added**

| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `agent` | User agent - eg. agent="Mozilla/5.0" | `string` | 1024 | Virus | 9241_-_LOG_ID_UNKNOWN_CE_BLOCK, 9242_-_LOG_ID_UNKNOWN_CE_BYPASS |
| `direction` | Message/packets direction | `string` | 8 | Virus | 9241_-_LOG_ID_UNKNOWN_CE_BLOCK, 9242_-_LOG_ID_UNKNOWN_CE_BYPASS |
| `echmsg` | *(empty)* | `string` | 64 | DNS | 54200_-_LOG_ID_DNS_RESOLV_ERROR, 54400_-_LOG_ID_DNS_URL_FILTER_BLOCK, 54401_-_LOG_ID_DNS_URL_FILTER_ALLOW, 54600_-_LOG_ID_DNS_BOTNET_IP, 54601_-_LOG_ID_DNS_BOTNET_DOMAIN *(+6 more)* |
| `httpmethod` | *(empty)* | `string` | 20 | Virus | 9241_-_LOG_ID_UNKNOWN_CE_BLOCK, 9242_-_LOG_ID_UNKNOWN_CE_BYPASS |
| `icberror` | *(empty)* | `string` | 32 | Virus | 8220_-_MESGID_ICB_WARNING, 8221_-_MESGID_ICB_NOTIF, 8222_-_MESGID_MIME_ICB_WARNING, 8223_-_MESGID_MIME_ICB_NOTIF, 8224_-_MESGID_ICB_TIMEOUT_WARNING *(+7 more)* |
| `policytype` | *(empty)* | `string` | 24 | Virus | 9241_-_LOG_ID_UNKNOWN_CE_BLOCK, 9242_-_LOG_ID_UNKNOWN_CE_BYPASS |
| `poluuid` | *(empty)* | `string` | 37 | ICAP | 60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_CONN_ERROR |
| `risklevel` | *(empty)* | `string` | 36 | Webfilter | 12688_-_LOG_ID_WEB_SSL_EXEMPT, 13056_-_LOG_ID_WEB_FTGD_CAT_BLK, 13057_-_LOG_ID_WEB_FTGD_CAT_WARN, 13058_-_LOG_ID_WEB_FTGD_RISK_BLK, 13312_-_LOG_ID_WEB_FTGD_CAT_ALLOW *(+4 more)* |

**Fields removed**

| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `analyticscksum` | *(empty)* | `string` | 64 | Virus | 8220_-_MESGID_ICB_WARNING, 8221_-_MESGID_ICB_NOTIF, 8222_-_MESGID_MIME_ICB_WARNING, 8223_-_MESGID_MIME_ICB_NOTIF, 8224_-_MESGID_ICB_TIMEOUT_WARNING *(+7 more)* |
| `attack` | *(empty)* | `string` | 256 | VoIP | 44032_-_LOGID_EVENT_VOIP_SIP |
| `attackid` | *(empty)* | `uint32` | 10 | VoIP | 44032_-_LOGID_EVENT_VOIP_SIP |
| `cdrcontent` | *(empty)* | `string` | 256 | Virus | 8220_-_MESGID_ICB_WARNING, 8221_-_MESGID_ICB_NOTIF, 8222_-_MESGID_MIME_ICB_WARNING, 8223_-_MESGID_MIME_ICB_NOTIF, 8224_-_MESGID_ICB_TIMEOUT_WARNING *(+7 more)* |
| `contentdisarmed` | *(empty)* | `string` | 13 | Virus | 8220_-_MESGID_ICB_WARNING, 8221_-_MESGID_ICB_NOTIF, 8222_-_MESGID_MIME_ICB_WARNING, 8223_-_MESGID_MIME_ICB_NOTIF, 8224_-_MESGID_ICB_TIMEOUT_WARNING *(+7 more)* |
| `filehash` | *(empty)* | `string` | 64 | Virus | 8220_-_MESGID_ICB_WARNING, 8221_-_MESGID_ICB_NOTIF, 8222_-_MESGID_MIME_ICB_WARNING, 8223_-_MESGID_MIME_ICB_NOTIF, 8224_-_MESGID_ICB_TIMEOUT_WARNING *(+7 more)* |
| `filehashsrc` | *(empty)* | `string` | 32 | Virus | 8220_-_MESGID_ICB_WARNING, 8221_-_MESGID_ICB_NOTIF, 8222_-_MESGID_MIME_ICB_WARNING, 8223_-_MESGID_MIME_ICB_NOTIF, 8224_-_MESGID_ICB_TIMEOUT_WARNING *(+7 more)* |
| `icbaction` | *(empty)* | `string` | 7 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING, 8195_-_MESGID_INFECT_MIME_NOTIF, 8202_-_MESGID_AVQUERY_WARNING *(+39 more)* |
| `icbconfidence` | *(empty)* | `string` | 6 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING, 8195_-_MESGID_INFECT_MIME_NOTIF, 8202_-_MESGID_AVQUERY_WARNING *(+39 more)* |
| `icbfileid` | *(empty)* | `string` | 65 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING, 8195_-_MESGID_INFECT_MIME_NOTIF, 8202_-_MESGID_AVQUERY_WARNING *(+39 more)* |
| `icbfiletype` | *(empty)* | `string` | 10 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING, 8195_-_MESGID_INFECT_MIME_NOTIF, 8202_-_MESGID_AVQUERY_WARNING *(+39 more)* |
| `icbseverity` | *(empty)* | `string` | 11 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING, 8195_-_MESGID_INFECT_MIME_NOTIF, 8202_-_MESGID_AVQUERY_WARNING *(+39 more)* |
| `icbverdict` | *(empty)* | `string` | 5 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING, 8195_-_MESGID_INFECT_MIME_NOTIF, 8202_-_MESGID_AVQUERY_WARNING *(+39 more)* |

**Length changes**

| Log Field Name | Old Length | New Length | Type | LOGIDs |
|----------------|------------|------------|------|--------|
| `itype` | 16 | 32 | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING, 8195_-_MESGID_INFECT_MIME_NOTIF, 8202_-_MESGID_AVQUERY_WARNING *(+51 more)* |
