...
|------|--------|--------|------------|---------------|
| APP-CTRL | 77 | 14 | 3 | port-violation, protocol-violation, signature |
...
| ICAP | 40 | 3 | 1 | icap |
| IPS | 70 | 6 | 3 | botnet, malicious-url, signature |
...
| `action` | Policy Action | `string` | 65 | connector<br>router<br>system<br>user<br>vpn<br>wireless | 53200_-_LOG_ID_CONNECTOR_OBJECT_ADD, 53201_-_LOG_ID_CONNECTOR_OBJECT_REMOVE<br>20401_-_LOG_ID_ROUTER_CLEAR, 51000_-_LOG_ID_NB_TBL_CHG<br>20002_-_LOG_ID_DOMAIN_UNRESOLVABLE, 20003_-_LOG_ID_MAIL_SENT_FAIL, 20021_-_LOG_ID_MAIL_RESENT *(+227 more)*<br>38010_-_LOG_ID_FIPS_ENCRY_FAIL, 38011_-_LOG_ID_FIPS_DECRY_FAIL, 38012_-_LOG_ID_ENTROPY_TOKEN *(+30 more)*<br>23101_-_LOG_ID_IPSEC_TUNNEL_UP, 23102_-_LOG_ID_IPSEC_TUNNEL_DOWN, 23103_-_LOG_ID_IPSEC_TUNNEL_STAT *(+73 more)*<br>43520_-_LOG_ID_EVENT_WIRELESS_SYS, 43521_-_LOG_ID_EVENT_WIRELESS_ROGUE, 43522_-_LOG_ID_EVENT_WIRELESS_WTP *(+190 more)* |
...
| `date` | Date | `string` | 10 | connector<br>endpoint<br>fortiextender<br>ha<br>rest-api<br>router<br>sdwan<br>security-rating<br>system<br>user<br>vpn<br>wanopt<br>webproxy<br>wireless | 53200_-_LOG_ID_CONNECTOR_OBJECT_ADD, 53201_-_LOG_ID_CONNECTOR_OBJECT_REMOVE, 53202_-_LOG_ID_CONNECTOR_API_FAILED *(+3 more)*<br>45071_-_LOG_ID_FCC_VULN_SCAN, 45101_-_LOG_ID_EC_REG_SUCCEED, 45114_-_LOG_ID_EC_REG_QUARANTINE *(+15 more)*<br>46400_-_LOG_ID_EVENT_EXT_SYS, 46401_-_LOG_ID_EVENT_EXT_LOCAL, 46402_-_LOG_ID_EVENT_EXT_LOCAL_ERROR *(+8 more)*<br>35001_-_LOG_ID_HA_SYNC_VIRDB, 35002_-_LOG_ID_HA_SYNC_ETDB, 35003_-_LOG_ID_HA_SYNC_EXDB *(+34 more)*<br>47301_-_LOG_ID_EVENT_REST_API_OK, 47302_-_LOG_ID_EVENT_REST_API_ERR<br>20300_-_LOG_ID_BGP_NB_STAT_CHG, 20301_-_LOG_ID_VZ_LOG_INFO, 20302_-_LOG_ID_OSPF_NB_STAT_CHG *(+7 more)*<br>22923_-_LOG_ID_EVENT_VWL_LQTY_STATUS, 22924_-_LOG_ID_EVENT_VWL_VOLUME_STATUS, 22925_-_LOG_ID_EVENT_VWL_SLA_INFO *(+13 more)*<br>52000_-_LOG_ID_EVENT_SECURITY_AUDIT_FABRIC_SUMMARY, 52001_-_LOG_ID_EVENT_SECURITY_AUDIT_FABRIC_CHANGE<br>20002_-_LOG_ID_DOMAIN_UNRESOLVABLE, 20003_-_LOG_ID_MAIL_SENT_FAIL, 20004_-_LOG_ID_POLICY_TOO_BIG *(+600 more)*<br>38010_-_LOG_ID_FIPS_ENCRY_FAIL, 38011_-_LOG_ID_FIPS_DECRY_FAIL, 38012_-_LOG_ID_ENTROPY_TOKEN *(+50 more)*<br>23101_-_LOG_ID_IPSEC_TUNNEL_UP, 23102_-_LOG_ID_IPSEC_TUNNEL_DOWN, 23103_-_LOG_ID_IPSEC_TUNNEL_STAT *(+73 more)*<br>48040_-_LOG_ID_WANOPT_TUNNEL_CREATE, 48041_-_LOG_ID_WANOPT_TUNNEL_CLOSED, 48101_-_LOG_ID_WANOPT_AUTH_FAIL_PSK *(+2 more)*<br>40960_-_LOGID_EVENT_WEBPROXY_FWD_SRV_ERROR, 40961_-_LOGID_EVENT_ICAP_REMOTE_SRV_STAT<br>43520_-_LOG_ID_EVENT_WIRELESS_SYS, 43521_-_LOG_ID_EVENT_WIRELESS_ROGUE, 43522_-_LOG_ID_EVENT_WIRELESS_WTP *(+190 more)* |
...
| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `fctuid` | *(empty)* | `string` | 32 | vpn | 37120_-_MESGID_NEG_GENERIC_P1_NOTIF, 37121_-_MESGID_NEG_GENERIC_P1_ERROR, 37122_-_MESGID_NEG_GENERIC_P2_NOTIF *(+31 more)* |
...
| `msg` | Log Message | `string` | 4096 | connector<br>endpoint<br>fortiextender<br>ha<br>router<br>sdwan<br>system<br>user<br>vpn<br>wanopt<br>webproxy<br>wireless | 53200_-_LOG_ID_CONNECTOR_OBJECT_ADD, 53201_-_LOG_ID_CONNECTOR_OBJECT_REMOVE, 53202_-_LOG_ID_CONNECTOR_API_FAILED *(+3 more)*<br>45071_-_LOG_ID_FCC_VULN_SCAN, 45101_-_LOG_ID_EC_REG_SUCCEED, 45114_-_LOG_ID_EC_REG_QUARANTINE *(+15 more)*<br>46400_-_LOG_ID_EVENT_EXT_SYS, 46401_-_LOG_ID_EVENT_EXT_LOCAL, 46402_-_LOG_ID_EVENT_EXT_LOCAL_ERROR *(+8 more)*<br>35001_-_LOG_ID_HA_SYNC_VIRDB, 35002_-_LOG_ID_HA_SYNC_ETDB, 35003_-_LOG_ID_HA_SYNC_EXDB *(+34 more)*<br>20300_-_LOG_ID_BGP_NB_STAT_CHG, 20301_-_LOG_ID_VZ_LOG_INFO, 20302_-_LOG_ID_OSPF_NB_STAT_CHG *(+7 more)*<br>22923_-_LOG_ID_EVENT_VWL_LQTY_STATUS, 22924_-_LOG_ID_EVENT_VWL_VOLUME_STATUS, 22925_-_LOG_ID_EVENT_VWL_SLA_INFO *(+13 more)*<br>20002_-_LOG_ID_DOMAIN_UNRESOLVABLE, 20003_-_LOG_ID_MAIL_SENT_FAIL, 20004_-_LOG_ID_POLICY_TOO_BIG *(+595 more)*<br>38010_-_LOG_ID_FIPS_ENCRY_FAIL, 38011_-_LOG_ID_FIPS_DECRY_FAIL, 38012_-_LOG_ID_ENTROPY_TOKEN *(+50 more)*<br>23101_-_LOG_ID_IPSEC_TUNNEL_UP, 23102_-_LOG_ID_IPSEC_TUNNEL_DOWN, 23103_-_LOG_ID_IPSEC_TUNNEL_STAT *(+73 more)*<br>48040_-_LOG_ID_WANOPT_TUNNEL_CREATE, 48041_-_LOG_ID_WANOPT_TUNNEL_CLOSED, 48101_-_LOG_ID_WANOPT_AUTH_FAIL_PSK *(+2 more)*<br>40960_-_LOGID_EVENT_WEBPROXY_FWD_SRV_ERROR, 40961_-_LOGID_EVENT_ICAP_REMOTE_SRV_STAT<br>43520_-_LOG_ID_EVENT_WIRELESS_SYS, 43521_-_LOG_ID_EVENT_WIRELESS_ROGUE, 43522_-_LOG_ID_EVENT_WIRELESS_WTP *(+190 more)* |
...
| `user` | User name of authenticated user | `string` | 256 | endpoint<br>ha<br>rest-api<br>router<br>system<br>user<br>vpn<br>wireless | 45071_-_LOG_ID_FCC_VULN_SCAN, 45114_-_LOG_ID_EC_REG_QUARANTINE, 45115_-_LOG_ID_EC_REG_UNQUARANTINE *(+2 more)*<br>35014_-_LOG_ID_HA_RESET_UPTIME, 35015_-_LOG_ID_HA_CLEAR_HISTORY<br>47301_-_LOG_ID_EVENT_REST_API_OK, 47302_-_LOG_ID_EVENT_REST_API_ERR<br>20401_-_LOG_ID_ROUTER_CLEAR<br>20002_-_LOG_ID_DOMAIN_UNRESOLVABLE, 20003_-_LOG_ID_MAIL_SENT_FAIL, 20004_-_LOG_ID_POLICY_TOO_BIG *(+186 more)*<br>38010_-_LOG_ID_FIPS_ENCRY_FAIL, 38011_-_LOG_ID_FIPS_DECRY_FAIL, 38012_-_LOG_ID_ENTROPY_TOKEN *(+25 more)*<br>23101_-_LOG_ID_IPSEC_TUNNEL_UP, 23102_-_LOG_ID_IPSEC_TUNNEL_DOWN, 23103_-_LOG_ID_IPSEC_TUNNEL_STAT *(+54 more)*<br>43524_-_LOG_ID_EVENT_WIRELESS_STA, 43572_-_LOG_ID_EVENT_WIRELESS_STA_ASSO, 43573_-_LOG_ID_EVENT_WIRELESS_STA_AUTH *(+65 more)* |
...
| `agent` | User agent - eg. agent="Mozilla/5.0" | `string` | 1024 | DLP<br>Virus<br>Webfilter | 24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+49 more)*<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+59 more)* |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `attack` | *(empty)* | `string` | 256 | VoIP<br>virtual-patch | 44032_-_LOGID_EVENT_VOIP_SIP, 44034_-_LOGID_EVENT_VOIP_SIP_FUZZING<br>64600_-_LOG_ID_OT_VPATCH_BLOCK, 64601_-_LOG_ID_OT_VPATCH_LOG, 64610_-_LOG_ID_LOCALIN_VPATCH_BLOCK *(+1 more)* |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `attackid` | *(empty)* | `uint32` | 10 | VoIP<br>virtual-patch | 44032_-_LOGID_EVENT_VOIP_SIP, 44034_-_LOGID_EVENT_VOIP_SIP_FUZZING<br>64600_-_LOG_ID_OT_VPATCH_BLOCK, 64601_-_LOG_ID_OT_VPATCH_LOG, 64610_-_LOG_ID_LOCALIN_VPATCH_BLOCK *(+1 more)* |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `srcmac` | *(empty)* | `string` | 17 | DLP<br>EmailFilter<br>FILE-FILTER<br>ICAP<br>IPS<br>SSL<br>Virus<br>Webfilter<br>casb | 24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF<br>20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF *(+2 more)*<br>64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_CONN_ERROR<br>16384_-_LOGID_ATTCK_SIGNATURE_TCP_UDP, 16385_-_LOGID_ATTCK_SIGNATURE_ICMP, 16386_-_LOGID_ATTCK_SIGNATURE_OTHERS *(+3 more)*<br>62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY *(+18 more)*<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+67 more)*<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+45 more)*<br>10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR |
| `srcmac` | MAC address associated with the Source IP | `string` | 17 | DNS | 54000_-_LOG_ID_DNS_QUERY, 54200_-_LOG_ID_DNS_RESOLV_ERROR, 54400_-_LOG_ID_DNS_URL_FILTER_BLOCK *(+9 more)* |
...
| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `transid` | *(empty)* | `uint32` | 10 | APP-CTRL<br>DLP<br>EmailFilter<br>FILE-FILTER<br>ICAP<br>IPS<br>SSL<br>Virus<br>WAF<br>Webfilter | 28704_-_LOGID_APP_CTRL_IPS_PASS, 28705_-_LOGID_APP_CTRL_IPS_BLOCK, 28706_-_LOGID_APP_CTRL_IPS_RESET *(+2 more)*<br>24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF<br>20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF *(+2 more)*<br>64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG<br>60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_CONN_ERROR<br>16384_-_LOGID_ATTCK_SIGNATURE_TCP_UDP, 16385_-_LOGID_ATTCK_SIGNATURE_ICMP, 16386_-_LOGID_ATTCK_SIGNATURE_OTHERS *(+3 more)*<br>62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY *(+18 more)*<br>8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING *(+69 more)*<br>30248_-_LOGID_WAF_SIGNATURE_BLOCK, 30249_-_LOGID_WAF_SIGNATURE_PASS, 30250_-_LOGID_WAF_SIGNATURE_ERASE *(+9 more)*<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+25 more)* |
...
| `trueclntip` | True-Client-IP HTTP header | `ip` | 39 | IPS<br>Webfilter | 16384_-_LOGID_ATTCK_SIGNATURE_TCP_UDP, 16385_-_LOGID_ATTCK_SIGNATURE_ICMP, 16386_-_LOGID_ATTCK_SIGNATURE_OTHERS *(+3 more)*<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+45 more)* |
...
| `vrf` | Virtual Routing Forwarding | `uint16` | 3 | APP-CTRL<br>DLP | 28672_-_LOGID_APP_CTRL_IM_BASIC, 28673_-_LOGID_APP_CTRL_IM_BASIC_WITH_STATUS, 28674_-_LOGID_APP_CTRL_IM_BASIC_WITH_COUNT *(+11 more)*<br>24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF |
| `vrf` | Virtual router forwarding | `uint16` | 3 | Anomaly<br>IPS<br>Webfilter | 18432_-_LOGID_ATTCK_ANOMALY_TCP_UDP, 18433_-_LOGID_ATTCK_ANOMALY_ICMP, 18434_-_LOGID_ATTCK_ANOMALY_OTHERS<br>16384_-_LOGID_ATTCK_SIGNATURE_TCP_UDP, 16385_-_LOGID_ATTCK_SIGNATURE_ICMP, 16386_-_LOGID_ATTCK_SIGNATURE_OTHERS *(+3 more)*<br>12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD *(+45 more)* |

---

### 7.6.0 → 7.6.1 — Inter-version Changes
...
|----------------|-------------|-----------|--------|--------|
| `countapp` | Number of App Ctrl logs associated with the session | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countav` | Number of AV logs associated with the session | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countcasb` | *(empty)* | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countcifs` | *(empty)* | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countdlp` | Number of DLP logs associated with the session | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countdns` | Number of DNS Query logs associated with the session | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countemail` | Number of Email logs associated with the session | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countff` | *(empty)* | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `counticap` | *(empty)* | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countips` | Number of IPS logs associated with the session | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countsctpf` | *(empty)* | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countssh` | Number of SSH logs associated with the session | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countssl` | *(empty)* | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countvpatch` | *(empty)* | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countwaf` | Number of WAF logs associated with the session | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `countweb` | Number of Web Filter logs associated with the session | `uint32` | 10 | 26_-_LOG_ID_TRAFFIC_HTTP_TRANSACTION |
| `tcpnrt` | *(empty)* | `uint32` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `tcporgrtrs` | *(empty)* | `uint32` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `tcprplrtrs` | *(empty)* | `uint32` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `tcprst` | *(empty)* | `string` | 6 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `tcpsrt` | *(empty)* | `uint32` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `tcpsynackrtrs` | *(empty)* | `uint32` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
| `tcpsynrtrs` | *(empty)* | `uint32` | 10 | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |

**Type changes**

| Log Field Name | Old Type | New Type | LOGIDs |
|----------------|----------|----------|--------|
| `vrf` | `uint8` | `uint16` | 10_-_LOG_ID_TRAFFIC_EXPLICIT_PROXY, 11_-_LOG_ID_TRAFFIC_FAIL_CONN, 12_-_LOG_ID_TRAFFIC_MULTICAST, 13_-_LOG_ID_TRAFFIC_END_FORWARD, 14_-_LOG_ID_TRAFFIC_END_LOCAL *(+16 more)* |
...
| LOGID | Category |
|-------|----------|
| `22818_-_LOG_ID_SCANUNIT_DLP_BUILDER_TIMEOUT` | system |
| `22906_-_LOG_ID_SECURITY_LEVEL_CHANGE` | system |
| `22907_-_LOG_ID_INPUT_DETECTION` | system |
| `22908_-_LOG_ID_OUTPUT_DETECTION` | system |
| `22957_-_LOG_ID_SANDBOX_CLOUD_ERRCON` | system |
| `32310_-_LOG_ID_USB_DEVICE_DETECTED` | system |
| `32311_-_LOG_ID_USB_DEVICE_MOUNTED` | system |
| `32312_-_LOG_ID_USB_DEVICE_EJECTED` | system |
| `32625_-_LOG_ID_FGT_SWITCH_IMG_VERIFICATION` | switch-controller |
| `37142_-_MESGID_TRANSPORT_SWITCH` | vpn |
| `43536_-_LOG_ID_EVENT_WIRELESS_WIDS_GENERAL` | wireless |
| `43537_-_LOG_ID_EVENT_WIRELESS_WIDS_RISKY_ENCRYPTION` | wireless |
| `43538_-_LOG_ID_EVENT_WIRELESS_WIDS_VALID_STA_MISASSOC` | wireless |
| `43723_-_LOG_ID_EVENT_WIRELESS_SYS_AC_DOWN` | wireless |
| `45134_-_LOG_ID_EC_SHM_ENDPOINT_UPDATE` | endpoint |
| `45135_-_LOG_ID_EC_SHM_ENDPOINT_DELETE` | endpoint |
| `46527_-_LOG_ID_INTERNAL_LTE_MODEM_SIM_SWITCH_SIM_STATE` | system |
| `53407_-_LOG_ID_FABRIC_VPN_PSK_SECRET_UPG_SET` | system |

**LOGIDs removed**

| LOGID | Category |
|-------|----------|
| `40708_-_LOG_ID_EVENT_SYS_FTGD_RESOURCE_FAIL` | system |

**Fields added**

| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `url` | URL | `string` | 512 | user | 43025_-_LOG_ID_EVENT_AUTH_PROXY_SUCCESS, 43026_-_LOG_ID_EVENT_AUTH_PROXY_FAILED, 43028_-_LOG_ID_EVENT_AUTH_PROXY_GROUP_INFO_FAILED, 43032_-_LOG_ID_EVENT_AUTH_PROXY_USER_LIMIT_REACHED, 43033_-_LOG_ID_EVENT_AUTH_PROXY_MULTIPLE_LOGIN |

**Fields removed**

| Log Field Name | Description | Data Type | Length | Category | LOGIDs |
|----------------|-------------|-----------|--------|----------|--------|
| `ui` | User Interface | `string` | 64 | system | 32119_-_LOG_ID_UPD_SCANUNIT_AV_DB |
| `user` | User name of authenticated user | `string` | 256 | system | 32119_-_LOG_ID_UPD_SCANUNIT_AV_DB |

**Type changes**

| Log Field Name | Old Type | New Type | Category | LOGIDs |
|----------------|----------|----------|----------|--------|
| `vrf` | `uint8` | `uint16` | system | 20007_-_LOG_ID_SOCKET_EXHAUSTED |
...
| LOGID | Type |
|-------|------|
| `13058_-_LOG_ID_WEB_FTGD_RISK_BLK` | Webfilter |
| `13313_-_LOG_ID_WEB_FTGD_RISK_ALLOW` | Webfilter |
| `61014_-_LOG_ID_SSH_UNSUPPORT_PROTO_BLOCK` | SSH |
| `61015_-_LOG_ID_SSH_UNSUPPORT_PROTO_PASS` | SSH |

**Fields added**

| Log Field Name | Description | Data Type | Length | Type | LOGIDs |
|----------------|-------------|-----------|--------|------|--------|
| `attack` | *(empty)* | `string` | 256 | VoIP | 44032_-_LOGID_EVENT_VOIP_SIP, 44034_-_LOGID_EVENT_VOIP_SIP_FUZZING |
| `attackid` | *(empty)* | `uint32` | 10 | VoIP | 44032_-_LOGID_EVENT_VOIP_SIP, 44034_-_LOGID_EVENT_VOIP_SIP_FUZZING |
| `msg` | *(empty)* | `string` | 518 | virtual-patch | 64600_-_LOG_ID_OT_VPATCH_BLOCK, 64601_-_LOG_ID_OT_VPATCH_LOG, 64610_-_LOG_ID_LOCALIN_VPATCH_BLOCK, 64611_-_LOG_ID_LOCALIN_VPATCH_LOG |
| `subaction` | *(empty)* | `string` | 80 | casb | 10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR |
| `tenantmatch` | *(empty)* | `string` | 80 | casb | 10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR |
| `urlrisk` | *(empty)* | `uint8` | 3 | Webfilter | 12688_-_LOG_ID_WEB_SSL_EXEMPT, 13056_-_LOG_ID_WEB_FTGD_CAT_BLK, 13057_-_LOG_ID_WEB_FTGD_CAT_WARN, 13312_-_LOG_ID_WEB_FTGD_CAT_ALLOW, 13315_-_LOG_ID_WEB_FTGD_QUOTA_COUNTING *(+2 more)* |

**Type changes**

| Log Field Name | Old Type | New Type | Type | LOGIDs |
|----------------|----------|----------|------|--------|
| `vrf` | `uint8` | `uint16` | APP-CTRL | 28672_-_LOGID_APP_CTRL_IM_BASIC, 28673_-_LOGID_APP_CTRL_IM_BASIC_WITH_STATUS, 28674_-_LOGID_APP_CTRL_IM_BASIC_WITH_COUNT, 28675_-_LOGID_APP_CTRL_IM_FILE, 28676_-_LOGID_APP_CTRL_IM_CHAT *(+9 more)* |
| `vrf` | `uint8` | `uint16` | Anomaly | 18432_-_LOGID_ATTCK_ANOMALY_TCP_UDP, 18433_-_LOGID_ATTCK_ANOMALY_ICMP, 18434_-_LOGID_ATTCK_ANOMALY_OTHERS |
| `vrf` | `uint8` | `uint16` | DLP | 24576_-_LOG_ID_DLP_WARN, 24577_-_LOG_ID_DLP_NOTIF |
| `vrf` | `uint8` | `uint16` | EmailFilter | 20480_-_LOGID_ANTISPAM_EMAIL_NOTIF, 20481_-_LOGID_EMAIL_GENERAL_NOTIF, 20482_-_LOGID_ANTISPAM_EMAIL_BWORD_NOTIF, 20509_-_LOGID_ANTISPAM_FTGD_ERR, 20510_-_LOGID_ANTISPAM_EMAIL_WEBMAIL_NOTIF |
| `vrf` | `uint8` | `uint16` | FILE-FILTER | 64000_-_LOG_ID_FILE_FILTER_BLOCK, 64001_-_LOG_ID_FILE_FILTER_LOG |
| `vrf` | `uint8` | `uint16` | ICAP | 60000_-_LOG_ID_ICAP_SERVER_ERROR, 60001_-_LOG_ID_ICAP_INFECTION_BLOCK, 60002_-_LOG_ID_ICAP_CONN_ERROR |
| `vrf` | `uint8` | `uint16` | IPS | 16384_-_LOGID_ATTCK_SIGNATURE_TCP_UDP, 16385_-_LOGID_ATTCK_SIGNATURE_ICMP, 16386_-_LOGID_ATTCK_SIGNATURE_OTHERS, 16399_-_LOGID_ATTACK_MALICIOUS_URL, 16400_-_LOGID_ATTACK_BOTNET_WARNING *(+1 more)* |
| `vrf` | `uint8` | `uint16` | SSL | 62004_-_LOG_ID_SSL_EXEMPT_ADDR, 62006_-_LOG_ID_SSL_EXEMPT_ALLOWLIST, 62007_-_LOG_ID_SSL_EXEMPT_FTGD_CATEGORY, 62008_-_LOG_ID_SSL_EXEMPT_LOCAL_CATEGORY, 62009_-_LOG_ID_SSL_EXEMPT_USER_CATEGORY *(+16 more)* |
| `vrf` | `uint8` | `uint16` | Virus | 8192_-_MESGID_INFECT_WARNING, 8193_-_MESGID_INFECT_NOTIF, 8194_-_MESGID_INFECT_MIME_WARNING, 8195_-_MESGID_INFECT_MIME_NOTIF, 8200_-_MESGID_MIME_FILETYPE_EXE_WARNING *(+67 more)* |
| `vrf` | `uint8` | `uint16` | Webfilter | 12288_-_LOG_ID_WEB_CONTENT_BANWORD, 12290_-_LOG_ID_WEB_CONTENT_EXEMPTWORD, 12292_-_LOG_ID_WEB_CONTENT_KEYWORD, 12293_-_LOG_ID_WEB_CONTENT_SEARCH, 12544_-_LOG_ID_URL_FILTER_BLOCK *(+53 more)* |
| `vrf` | `uint8` | `uint16` | casb | 10000_-_LOG_ID_CASB_ACCESS_BLOCKED, 10001_-_LOG_ID_CASB_ACCESS_BYPASS, 10002_-_LOG_ID_CASB_ACCESS_MONITOR |
| `vrf` | `uint8` | `uint16` | virtual-patch | 64600_-_LOG_ID_OT_VPATCH_BLOCK, 64601_-_LOG_ID_OT_VPATCH_LOG, 64610_-_LOG_ID_LOCALIN_VPATCH_BLOCK, 64611_-_LOG_ID_LOCALIN_VPATCH_LOG |
